        ...
        <footer className="py-5">
            <div className="container">
                <div className="d-flex flex-wrap justify-content-around gap-3">
                    <div className="">
                        <h5 className="fw-bold">Bienestar Integral</h5>
                        <ul className="list-unstyled">
                            <li>Monseñor Tavella 1424</li>
                            <li>Concordia, CP 3200</li>
                            <li>Provincia de Entre Rios</li>
                            <li>Tel: (+54) (345) 4231400</li>
                            <li>Email: informes.fcad@uner.edu.ar</li>
                        </ul>
                    </div>
                    ...
                    <div className="">
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><Link to={'/institucional'} className="text-decoration-none">Institucional</Link>
                            </li>
                            <li><Link to={'/profesionales'} className="text-decoration-none">Profesionales</Link></li>
                            <li><Link to={'/contacto'} className="text-decoration-none">Contacto</Link></li>
                        </ul>
                    </div>
                        ...
                        <ul className="list-inline">
                            <li className="list-inline-item me-3">
                                <Link to={'/'} aria-label="Facebook">
                                    <svg id="fb-icon" width="26" height="26" viewBox="0 0 24 24" fill="none"
                                        strokeWidth="2.1" xmlns="http://www.w3.org/2000/svg">
                                        <path
                            ...
                            <li className="list-inline-item me-3">
                                <Link to={'/'} aria-label="Instagram">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" strokeWidth="0.1"
                                        viewBox="0 0 16 16">
                                        <path
                ...
                <div className="row">
                    <div className="col-12 text-center">
                        <p className="text-secondary mb-0">2026 Bienestar Integral - Desarrollado por el Grupo J para tu salud
